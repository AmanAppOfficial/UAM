	...
	//get details of movie...
     ...
     .then(data => {
             ...
             if(data[0]["meta"]["parentalguidance"] == true){
            	 ...
            	 document.getElementById('synTxt1').style.display = "block";
            	 
             }
             
             
             if(data[0]["meta"]["geolimits"] == true){
            	 //show section of warning
            	 document.getElementById('synTxt2').style.display = "block";
             }
